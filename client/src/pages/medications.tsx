...
import { Pill, Plus, Trash2, Edit2, Clock, AlertCircle, CheckCircle2, Sunrise, Sun, Sunset, Moon, Printer, ExternalLink, Tag, ShieldAlert, ChevronDown } from "lucide-react";
        ...
        <div className="flex gap-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={0}>
                <Button size="sm" variant="outline" className="gap-1 opacity-50 cursor-not-allowed" disabled data-testid="button-print-medications">
                  <Printer className="w-4 h-4" /> Print
                </Button>
              </span>
            </TooltipTrigger>
            <TooltipContent>Disabled in demo</TooltipContent>
          </Tooltip>
