            ...
            <TooltipTrigger asChild>
              <span className="flex-1" tabIndex={0}>
                <Button
                  ...
                  size="sm"
                  disabled
                  className="w-full gap-1 font-body text-[11px] px-2 opacity-50 cursor-not-allowed"
                  data-testid="button-save-data"
                >
                  <Download className="w-3.5 h-3.5 flex-shrink-0" />
                  <span className="truncate">Save My Data</span>
                </Button>
              </span>
            </TooltipTrigger>
            ...
            <TooltipTrigger asChild>
              <span className="flex-1" tabIndex={0}>
                ...
                >
                  ...
                  <span className="truncate">Load My Data</span>
                </Button>
              </span>
            </TooltipTrigger>
            <TooltipContent>Disabled in demo</TooltipContent>
